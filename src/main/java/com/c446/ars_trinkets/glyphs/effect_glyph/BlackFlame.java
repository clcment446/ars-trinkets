...
public class BlackFlame extends AbstractEffect implements IDamageEffect {
    ...
    public void onResolveEntity(EntityHitResult rayTraceResult, Level world, @Nonnull LivingEntity shooter, SpellStats spellStats, SpellContext spellContext, SpellResolver resolver) {
        ...
        DamageSource source = DamageUtil.source(world, DamageTypes.IN_FIRE, shooter);
        ...
        if (rayTraceResult.getEntity() instanceof LivingEntity living && shooter instanceof Player player) {
            ...
            DamageSource src = DamageUtil.source(level, DamageTypesRegistry.FLARE, shooter);
            ...
            for (Entity e : world.getEntities(shooter, new AABB(
                ...
                damage = (float) (this.DAMAGE.get() + (6 * (1 + bonus.get())) + (this.AMP_VALUE.get() * spellStats.getAmpMultiplier()));
