 ...
 * Shamelessly cloned from the AN ParticleColor class
 */
public class OldParticleColor {
    public static class ParticleColor implements IParticleColor, Cloneable {
...
//        }
        ...
        public class IntWrapper implements Cloneable {
            public int r;
            public int g;
            public int b;
